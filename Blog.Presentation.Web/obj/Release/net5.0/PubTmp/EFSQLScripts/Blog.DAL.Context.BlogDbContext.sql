...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210519155928_v1')
BEGIN
...
BEGIN
    CREATE TABLE [Articles] (
        ...
        [ArticleImageUrl] nvarchar(max) NULL,
...
BEGIN
    CREATE TABLE [Comments] (
        [Id] int NOT NULL IDENTITY,
        [ArticleComment] nvarchar(max) NULL,
        [ArticleId] int NOT NULL,
        [CommentAuthorId] nvarchar(450) NULL,
        [CreatedDate] datetimeoffset NOT NULL,
        [ModifiedDate] datetimeoffset NOT NULL,
        [ModifiedBy] nvarchar(max) NULL,
        [CreatedBy] nvarchar(max) NULL,
        ...
        CONSTRAINT [FK_Comments_AspNetUsers_CommentAuthorId] FOREIGN KEY ([CommentAuthorId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION
    );
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210519155928_v1')
BEGIN
    CREATE INDEX [IX_Comments_CommentAuthorId] ON [Comments] ([CommentAuthorId]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20210519155928_v1', N'5.0.6');
END;
GO
